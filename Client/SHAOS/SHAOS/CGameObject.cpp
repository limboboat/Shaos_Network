...
CGameObject::CGameObject(int objTAG, POINTFLOAT ainitPos, TEAM ateam, map<int, CGameObject*>& aenemylist, CHp mhp)
	: objTAG{ objTAG }, mptpos(ainitPos), team(ateam), menemylist(aenemylist), mhp(mhp)
{
	mdeath = FALSE;
	ideatheffecttime = 0;
}
